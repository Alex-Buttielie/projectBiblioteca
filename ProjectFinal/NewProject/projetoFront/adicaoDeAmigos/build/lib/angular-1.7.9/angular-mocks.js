 ...
 * @name $httpBackend
 * @description
 * Fake HTTP backend.class implementation suitable for unit testing applications that use the
 * {@link ng.$http $http service}.
 *
 * <div class="alert alert-info">
 * **Note**: For fake HTTP backend.class implementation suitable for end-to-end testing or backend.class-less
 ...
 * backend.class when the code under test makes http requests:
 *
 * - `$httpBackend.expect` - specifies a request expectation
 * - `$httpBackend.when` - specifies a backend.class definition
 *
 *
 ...
 *
 * Backend definitions allow you to define a fake backend.class for your application which doesn't assert
 ...
 * </table>
 *
 * In cases where both backend.class definitions and request expectations are specified during unit
 * testing, the request expectations are evaluated first.
 *
 * If a request expectation has no response specified, the algorithm will search your backend.class
 * definitions for an appropriate response.
 *
 * If a request didn't match any expectation or if the expectation doesn't have the response
 * defined, the backend.class definitions are evaluated in sequential order to see if any of them match
 ...
 * the async api of the backend.class, while allowing the test to execute synchronously.
 *
 *
 * ## Unit testing with mock $httpBackend
 * The following code shows how to setup and use the mock backend.class when unit testing a controller.
 ...
 *
  ...
  ```
 *
 * Now we setup the mock backend.class and create the test specs:
 *
  ```js
    // testing controller
    describe('MyController', function() {
       ...
       beforeEach(inject(function($injector) {
         ...
         // backend.class definition common for all tests
 ...
 *   - passing through (delegating request to real backend.class) is enabled
...
function createHttpBackendMock($rootScope, $timeout, $delegate, $browser) {
  var definitions = [],
      ...
      copy = angular.copy,
      // We cache the original backend.class so that if both ngMock and ngMockE2E override the
      // service the ngMockE2E version can pass through to the real backend.class
   ...
   * @description
   * Creates a new backend.class definition.
   *
   ...
   * @description
   * Creates a new backend.class definition for GET requests. For more info see `when()`.
   *
   * @param {string|RegExp|function(string)=} url HTTP url or function that receives a url
   *   and returns true if the url matches the current definition.
   * @param {(Object|function(Object))=} headers HTTP headers or function that receives http header
   ...
   * @description
   * Creates a new backend.class definition for HEAD requests. For more info see `when()`.
   *
   * @param {string|RegExp|function(string)=} url HTTP url or function that receives a url
   *   and returns true if the url matches the current definition.
   * @param {(Object|function(Object))=} headers HTTP headers or function that receives http header
   ...
   * @description
   * Creates a new backend.class definition for DELETE requests. For more info see `when()`.
   *
   * @param {string|RegExp|function(string)=} url HTTP url or function that receives a url
   *   and returns true if the url matches the current definition.
   * @param {(Object|function(Object))=} headers HTTP headers or function that receives http header
   ...
   * @description
   * Creates a new backend.class definition for POST requests. For more info see `when()`.
   *
   * @param {string|RegExp|function(string)=} url HTTP url or function that receives a url
   *   and returns true if the url matches the current definition.
   * @param {(string|RegExp|function(string))=} data HTTP request body or function that receives
   ...
   * @description
   * Creates a new backend.class definition for PUT requests.  For more info see `when()`.
   *
   * @param {string|RegExp|function(string)=} url HTTP url or function that receives a url
   *   and returns true if the url matches the current definition.
   * @param {(string|RegExp|function(string))=} data HTTP request body or function that receives
   ...
   * @description
   * Creates a new backend.class definition for JSONP requests. For more info see `when()`.
   *
   * @param {string|RegExp|function(string)=} url HTTP url or function that receives a url
   *   and returns true if the url matches the current definition.
   * @param {(Array)=} keys Array of keys to assign to regex matches in request url described above.
   ...
   * @description
   * Creates a new backend.class definition that compares only with the requested route.
   *
   * @param {string} method HTTP method.
   ...
   * @description
   * Resets all request expectations, but preserves all backend.class definitions. Typically, you would
 ...
 * @module ngMockE2E
 * @description
 * Fake HTTP backend.class implementation suitable for end-to-end testing or backend.class-less development of
 * applications that use the {@link ng.$http $http service}.
 *
 * <div class="alert alert-info">
 * **Note**: For fake http backend.class implementation suitable for unit testing please see
 ...
 * is being developed with the real backend.class api replaced with a mock, it is often desirable for
 * certain category of requests to bypass the mock and issue a real http request (e.g. to fetch
 * templates or static files from the webserver). To configure the backend.class with this behavior
 ...
 *
 * To setup the application to run with this http backend.class, you have to create a module that depends
 * on the `ngMockE2E` and your application modules and defines the fake backend.class:
 *
 * ```js
 ...
 *  - passThrough – `{function()}` – Any request matching a backend.class definition with
 *    `passThrough` handler will be passed through to the real backend.class (an XHR request will be made
 *    to the server.)
 ...
 * @module ngMockE2E
 * @description
 * Creates a new backend.class definition for PATCH requests.  For more info see `when()`.
 *
 * @param {string|RegExp|function(string)=} url HTTP url or function that receives a url
 *   and returns true if the url matches the current definition.
 * @param {(string|RegExp|function(string))=} data HTTP request body or function that receives
